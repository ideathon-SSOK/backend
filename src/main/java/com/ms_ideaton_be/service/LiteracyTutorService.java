    ...
    public String explainWord(String word, String contextText, String targetLevel) {
        String prompt = String.format(
                "당신은 사용자의 문해력을 길러주는 친절한 전문 튜터입니다.\n" +
                        ...
                        "3. 첫 번째 섹션: <h4 style=\"color: #6A82FB; font-weight: bold; margin-bottom: 8px;\">이 단어, 여기선 이런 뜻이에요</h4>\n" +
                        "   - 내용: 사전적 정의를 피하고, 대상 독자의 눈높이에 맞춰 아주 쉬운 비유와 함께 단어의 본래 뜻을 풀이해주세요.\n" +
                        "4. 두 번째 섹션: <br><h4 style=\"color: #6A82FB; font-weight: bold; margin-bottom: 8px;\">왜 이 말이 여기 쓰였을까요?</h4>\n" +
                        "   - 내용: 주어진 [문맥] 안에서 이 단어가 어떤 역할을 하고 있는지, 전체 문장이 말하고자 하는 핵심은 무엇인지 설명해주세요.\n" +
                        "5. 세 번째 섹션: <br><h4 style=\"color: #6A82FB; font-weight: bold; margin-bottom: 8px;\">실제로는 이렇게 쓰여요 !</h4>\n" +
